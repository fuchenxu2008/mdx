...
<nav id="tab_bar" class="navbar navbar-inverse navbar-fixed-bottom center-block">
  <div>
      <a class="col-xs-3 tab_btn" href="/">
          <img src="{{ asset('pic/006-coins.svg') }}" alt="Trade Now"><br>
          <label>Trade Now</label>
      </a>
      <a class="col-xs-3 tab_btn" href="/chat">
          <img src="{{ asset('pic/004-chat.svg') }}" alt="Messaging"><br>
              <label>Message</label>
      </a>
      <a class="col-xs-3 tab_btn" href="/liked">
          <img src="{{ asset('pic/003-star.svg') }}" alt="Liked"><br>
          <label>Liked</label>
      </a>
      <a class="col-xs-3 tab_btn" id="tab_btn_me" href="/me">
          <img src="{{ asset('pic/001-social.svg') }}" alt="Me"><br>
          <label>Me</label>
      </a>
  </div>
</nav>
